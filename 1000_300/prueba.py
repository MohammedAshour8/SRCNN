...
low_res_file = nc.Dataset('../archivos_prueba/1km_300m/1km/AQUA_006.nc')
high_res_file = nc.Dataset('../archivos_prueba/1km_300m/300m/aligned_gaussian/MCI_006.nc')
