...
def plot_histogram(i):
    low_res_file = nc.Dataset('../archivos_prueba/750m_300m/prueba_' + str(i) + '/VIIRS_NOAA20_AFAI_VIIRS_NOAA20_AFAI.nc')
    high_res_file = nc.Dataset('../archivos_prueba/750m_300m/prueba_' + str(i) + '/MCI_OLCI_MCI_OLCI.nc')
...
model.load_state_dict(th.load('model_850.pth', map_location=th.device('cpu')))
