...
model.load_state_dict(th.load('model_750.pth', map_location=th.device('cpu')))

# make a prediction with the model
low_res_file = nc.Dataset('../archivos_prueba/750m_300m/prueba_3/VIIRS_NOAA20_AFAI_VIIRS_NOAA20_AFAI.nc')
high_res_file = nc.Dataset('../archivos_prueba/750m_300m/prueba_3/MCI_OLCI_MCI_OLCI.nc')
