...
image1 = nc.Dataset('../archivos_prueba/750m_300m/nuevos/750m/NOAA_022.nc').variables['afai'][:]
image2 = nc.Dataset('../archivos_prueba/750m_300m/nuevos/300m/MCI_022.nc').variables['MCI'][:]
...
image1 = F.resize(image1, (int(low_res_lon * 750/300), int(low_res_lat * 750/300)), interpolation=F.InterpolationMode.BICUBIC)
...
"""image1 = scipy.ndimage.gaussian_filter(image1, sigma=2)
image2 = scipy.ndimage.gaussian_filter(image2, sigma=2)"""
