...
def plot_histogram(i):
    low_res_file = nc.Dataset('../archivos_prueba/1km_750m/prueba_' + str(i) + '/MODIS_AQUA_AFAI_MODIS_AQUA_AFAI.nc')
    high_res_file = nc.Dataset('../archivos_prueba/1km_750m/prueba_' + str(i) + '/VIIRS_NOAA20_AFAI_VIIRS_NOAA20_AFAI.nc')

    low_res_data, low_res_data_resized, high_res_data = Interpolate(low_res_file, high_res_file, 'afai', 'afai').interpolate()
