...
model.load_state_dict(th.load(args.model))
model.eval()
...
low_res_data_resized = F.resize(low_res_data, (int(low_res_lon * 1000/750), int(low_res_lat * 1000/750)), interpolation=F.InterpolationMode.BICUBIC)
